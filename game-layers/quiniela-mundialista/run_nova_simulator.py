...
def _print_compact_recommendation(
    ...
    automation = refresh.get("research_automation", {})
    print("Research Automation:")
    print(f"Snapshot available: {_yes_no(bool(automation.get('snapshot_available', False)))}")
    print(f"Validation status: {automation.get('validation_status', 'missing')}")
    print(f"Valid for tactical bridge: {_yes_no(bool(automation.get('valid_for_tactical_bridge', False)))}")
    print(f"Valid for market weighting: {_yes_no(bool(automation.get('valid_for_market_weighting', False)))}")
    print(f"Valid for prediction context: {_yes_no(bool(automation.get('valid_for_prediction_context', False)))}")
    print(f"Auto applied: {_yes_no(bool(automation.get('auto_applied', False)))}")
