        ...
        report_matches.append(
            {
                ...
                "group_context_flags": _field(item, "group_context_flags", []),
                "group_strength_bucket": _field(item, "group_strength_bucket", "unknown"),
                "surprise_candidate_context": _field(item, "surprise_candidate_context", {}),
                "jornada3_trap_context": _field(item, "jornada3_trap_context", {}),
                "points_pressure_context": _field(item, "points_pressure_context", {}),
